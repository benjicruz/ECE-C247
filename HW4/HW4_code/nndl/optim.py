...
def sgd_nesterov_momentum(w, dw, config=None):
  ...
  v_prev = v
  v = v * config['momentum'] - dw * config['learning_rate']
  next_w = w + v + (v - v_prev) * config['momentum'] 
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def adam(w, dw, config=None):
  ...
  v_bias = config['v'] / (1 - (config['beta1'])**(config['t']))
  a_bias = config['a'] / (1 - (config['beta2'])**(config['t']))
  next_w = w - config['learning_rate'] / (np.sqrt(a_bias) + config['epsilon']) * v_bias
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
